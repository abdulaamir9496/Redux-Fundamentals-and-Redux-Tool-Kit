...
const store = (0, _redux.createStore)(reducer) //created store. if we use only store it shows. Uncaught ReferenceError: createStore is not defined
;
console.log(store);
...
store.dispatch() //who want reducer, action needs reducer. We can't call the reducer directly. In store we don't get reducer directly.
